    ...
    <NuxtLink to="/auth/signin" title="Sign In" class="hidden sm:inline-flex aspect-square items-center">
        <Transition name="pop-in" mode="out-in">
            <span v-if="userCookie" class="relative avatar">
                <img :src="DEFAULT_USER_AVATAR" class="rounded-full transform scale-125 shadow-md overflow-hidden border border-white my-auto" width="22" height="22" :alt="'link-title'" />
                <div class="account-dropdown">
                    <NuxtLink to="/checkout" class="hover:bg-gray-100">
                        <Icon name="ion:person-outline" size="16" />
